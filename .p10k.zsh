# Generated by Powerlevel10k configuration wizard on 2020-01-08 at 11:28 WIB.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 36529.
# Wizard options: nerdfont-complete + powerline, large icons, classic, light,
# angled separators, round heads, round tails, 2 lines, disconnected, left frame,
# sparse, many icons, fluent, transient_prompt.
...
() {
  ...
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_PREFIX='%76F╭─'
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_PREFIX='%76F├─'
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX='%76F╰─'
  # Connect right prompt lines with these symbols.
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_SUFFIX='%76F─╮'
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_SUFFIX='%76F─┤'
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_SUFFIX='%76F─╯'
  ...
  typeset -g POWERLEVEL9K_BATTERY_LOW_BACKGROUND=
  # Show battery in green when it's charging or fully charged.
  typeset -g POWERLEVEL9K_BATTERY_{CHARGING,CHARGED}_FOREGROUND=70
  typeset -g POWERLEVEL9K_BATTERY_{CHARGING,CHARGED}_BACKGROUND=
  ...
  #source on signal levels  - http://www.speedguide.net/faq/how-to-read-rssisignal-and-snrnoise-ratings-440
    ...
    if [[ ! -z "${signal// }" ]] && [[ ! $SNR -gt .10 ]] ; 
      then p10k segment -t $'\uf011' -f red ; # color='%F{red}' ; symbol="\uf011";
    fi
    ...
    if [[ -z "${signal// }" ]] && [[ "$net" -eq 200 ]] ; 
      then p10k segment -t $'\uf197' -f blue && p10k segment -t $ssid -f blue -b ; # color='%F{blue}' ; symbol="\uf197" ;
    fi

    #echo -n "%{$color%}$symbol " # \f1eb is wifi bars
    #p10k segment -t $'\uf1eb' -f green -b clear;
  }
